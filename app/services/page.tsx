...
const supportServices = [
  {
    name: "Blood Bank",
    description: "Safe blood supply for transfusions",
    availability: "24/7",
  },
  {
    name: "Physiotherapy",
  ...
  },
  {
    ...
    description: "Dietary planning and nutrition education",
    availability: "Mon-Fri 9AM-5PM",
  },
  {
    name: "Social Services",
    description: "Patient advocacy and support services",
    availability: "Mon-Fri 8AM-5PM",
  },
  {
    name: "Chaplaincy",
    description: "Spiritual care and counseling",
            ...
            >
              <Card className="text-center hover:shadow-lg transition-shadow duration-300 bg-red-50 border-red-200">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600 mb-4">
                    Explore expert tips, health advice & more
                  </p>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600">
              Comprehensive support services to enhance your healthcare
              experience
            </p>
          </motion.div>
